 ...
 * @package App\Models
 */
class MBuilding extends ModelBase
{
    use HasFactory;
//    use HasCompositePrimaryKey;


    // テーブル名はクラスの複数形のスネークケース（m_buildings）
...
//          セッションからログインユーザーのcompany_idを取得
            ...
            //            重複チェック
            $tmp = MBuilding::where('company_id',$company_id)
...
//                    ログインユーザーのcompany_idと一致しているか
                ...
                // 登録
                $instance = new MBuilding();
                $instance->company_id = $company_id;

//                内部ID(internal_id)の最大値取得
                $max_internal_id = MBuilding::where('company_id', $company_id)->max('internal_id');
